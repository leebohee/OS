...
main(int argc, char **argv)
{
  ...
  43:	75 e3                	jne    28 <main+0x28>
    kill(atoi(argv[i]));
  exit();
  45:	e8 88 02 00 00       	call   2d2 <exit>
main(int argc, char **argv)
{
  int i;
  ...
  53:	e8 e8 03 00 00       	call   440 <printf>
    exit();
  58:	e8 75 02 00 00       	call   2d2 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
malloc(uint nbytes)
{
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 28 0a 00 00    	mov    %edx,0xa28
      return (void*)(p + 1);
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
 74f:	c7 05 30 0a 00 00 00 	movl   $0x0,0xa30
 756:	00 00 00 
