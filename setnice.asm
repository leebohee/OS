...
int main(int argc, char** argv){
  ...
  35:	e8 f6 01 00 00       	call   230 <atoi>
  3a:	89 c6                	mov    %eax,%esi
  3c:	58                   	pop    %eax
  3d:	ff 73 04             	pushl  0x4(%ebx)
  40:	e8 eb 01 00 00       	call   230 <atoi>
  45:	5a                   	pop    %edx
  46:	59                   	pop    %ecx
  47:	56                   	push   %esi
  48:	50                   	push   %eax
  49:	e8 2c 03 00 00       	call   37a <setnice>
	exit();
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 24 0a 00 00       	mov    %eax,0xa24
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 24 0a 00 00 28 	movl   $0xa28,0xa24
 73d:	0a 00 00 
 740:	c7 05 28 0a 00 00 28 	movl   $0xa28,0xa28
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 28 0a 00 00       	mov    $0xa28,%eax
 74f:	c7 05 2c 0a 00 00 00 	movl   $0x0,0xa2c
 756:	00 00 00 
