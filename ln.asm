...
main(int argc, char *argv[])
{
  ...
  21:	e8 1a 04 00 00       	call   440 <printf>
    exit();
  26:	e8 a7 02 00 00       	call   2d2 <exit>
  }
  ...
  33:	e8 fa 02 00 00       	call   332 <link>
  38:	83 c4 10             	add    $0x10,%esp
  3b:	85 c0                	test   %eax,%eax
  3d:	78 05                	js     44 <main+0x44>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3f:	e8 8e 02 00 00       	call   2d2 <exit>
  if(argc != 3){
    printf(2, "Usage: ln old new\n");
    exit();
  }
...
gets(char *buf, int max)
{
 ...
 185:	57                   	push   %edi
 186:	6a 00                	push   $0x0
 188:	e8 5d 01 00 00       	call   2ea <read>
    if(cc < 1)
...
stat(char *n, struct stat *st)
{
 ...
 1ed:	e8 20 01 00 00       	call   312 <open>
  if(fd < 0)
 ...
 201:	50                   	push   %eax
 202:	e8 23 01 00 00       	call   32a <fstat>
 207:	89 c6                	mov    %eax,%esi
  close(fd);
 209:	89 1c 24             	mov    %ebx,(%esp)
 20c:	e8 e9 00 00 00       	call   2fa <close>
  return r;
...
atoi(const char *s)
{
 ...
 235:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  n = 0;
	...
	if(*s=='-'){
 238:	0f be 13             	movsbl (%ebx),%edx
 23b:	80 fa 2d             	cmp    $0x2d,%dl
 23e:	74 38                	je     278 <atoi+0x48>
		sign=1;
		s++;
	}
...
atoi(const char *s)
{
 ...
 256:	8d 44 42 d0          	lea    -0x30(%edx,%eax,2),%eax
  ...
  while('0' <= *s && *s <= '9')
 25a:	0f be 13             	movsbl (%ebx),%edx
 25d:	8d 4a d0             	lea    -0x30(%edx),%ecx
 260:	80 f9 09             	cmp    $0x9,%cl
 263:	76 eb                	jbe    250 <atoi+0x20>
 265:	89 c2                	mov    %eax,%edx
 267:	f7 da                	neg    %edx
 269:	83 fe 01             	cmp    $0x1,%esi
 26c:	0f 44 c2             	cmove  %edx,%eax
  if(sign==1){
		return n*(-1);
	}
 ...
 274:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  while('0' <= *s && *s <= '9')
 278:	0f be 53 01          	movsbl 0x1(%ebx),%edx
  ...
  n = 0;
	...
	if(*s=='-'){
		sign=1;
		s++;
 27c:	8d 43 01             	lea    0x1(%ebx),%eax
	}

  while('0' <= *s && *s <= '9')
 27f:	8d 4a d0             	lea    -0x30(%edx),%ecx
 282:	80 f9 09             	cmp    $0x9,%cl
 285:	77 09                	ja     290 <atoi+0x60>
 ...
 287:	89 c3                	mov    %eax,%ebx
  ...
  n = 0;
	...
	if(*s=='-'){
		sign=1;
 289:	be 01 00 00 00       	mov    $0x1,%esi
 28e:	eb b9                	jmp    249 <atoi+0x19>
		s++;
	}

  while('0' <= *s && *s <= '9')
 290:	31 c0                	xor    %eax,%eax
 292:	eb db                	jmp    26f <atoi+0x3f>
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 34 0a 00 00       	mov    %eax,0xa34
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 73d:	0a 00 00 
 740:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 38 0a 00 00       	mov    $0xa38,%eax
 74f:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 756:	00 00 00 
