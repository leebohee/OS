...
int test1(){
	sleep(5);
  11:	6a 05                	push   $0x5
  13:	e8 3a 03 00 00       	call   352 <sleep>
	printf(1, "Wake up!\n");
  18:	58                   	pop    %eax
  19:	5a                   	pop    %edx
...
int main(int argc, char** argv){
  test1();
	exit();
  26:	e8 97 02 00 00       	call   2c2 <exit>
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
...
int test1(){
  ...
  33:	83 ec 14             	sub    $0x14,%esp
	sleep(5);
  36:	6a 05                	push   $0x5
  38:	e8 15 03 00 00       	call   352 <sleep>
	printf(1, "Wake up!\n");
  3d:	58                   	pop    %eax
  3e:	5a                   	pop    %edx
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 64 07 00 00 	movzbl 0x764(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 5a 07 00 00       	mov    $0x75a,%eax
